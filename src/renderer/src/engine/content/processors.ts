...
const CLOCKS: Record<string, [[number | U, number, number, number], [number | U, number]]> = {
  ...
  "core-ultra7-256v": [[2.2, 4.8, 4.5, 3.8], [undefined, 1950]],
  "core-ultra5-236v": [[2.1, 4.7, 4.4, 3.6], [undefined, 1850]],
...
export const PROCESSORS: Part[] = [
  ...
  // The 16 GB Lunar Lake parts. The 256V is the 258V die with half the memory.
  cpu(
    "core-ultra7-256v",
    ...
    2030,
    { x: 27.5, y: 27, z: 1.5 },
    pw("lunar-lake", [8, 37], 25, 37, 17, 0.4, [[17, 7900], [30, 10200]], 1850, [30, 3950]),
    ["platform:intel", "mem:on-package", "dgpu"],
    { platform: "Lunar Lake", igpu: "Arc 140V", onPackageGb: 16 },
  ),
  cpu(
    "core-ultra5-236v",
    ...
    2030,
    { x: 27.5, y: 27, z: 1.5 },
    pw("lunar-lake", [8, 37], 25, 37, 17, 0.4, [[17, 7500], [30, 9600]], 1780, [30, 3300]),
    ["platform:intel", "mem:on-package", "dgpu"],
    { platform: "Lunar Lake", igpu: "Arc 130V", onPackageGb: 16 },
  ),
  cpu(
    "core-ultra-x9-388h",
