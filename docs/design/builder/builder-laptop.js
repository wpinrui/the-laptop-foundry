...
function screenTex(kind, ratio, name) {
...
function build(el) {
  ...
  const scr = new THREE.Mesh(new THREE.PlaneGeometry(sw, sh), new THREE.MeshBasicMaterial({ map: screenTex(A('screen', 'off'), ratio, A('name', 'Northfold')), toneMapped: false })); scr.position.set(0, chin + sh / 2, mm(0.6)); hinge.add(scr);
